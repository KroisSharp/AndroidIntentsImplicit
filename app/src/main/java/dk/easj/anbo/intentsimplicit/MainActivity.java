package dk.easj.anbo.intentsimplicit;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resultView = (TextView) findViewById(R.id.choice_textview_result);
    }
    ...
    public void browseButtonClicked(View view) {
        ...
        // Android Notes for Professionals, page 85
    }
    ...
    public void mapButtonClicked(View view) {
        try {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("geo:55.64337,12.1014303?z=16"));
            startActivity(intent);
        } catch (Exception ex) {
            Toast.makeText(getBaseContext(), "Cannot show map", Toast.LENGTH_LONG).show();
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        TextView resultView = (TextView) findViewById(R.id.choice_textview_result);
